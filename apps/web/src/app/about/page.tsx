...
const HISTORY = [
  ...
  },
  {
    ...
    description:
      "コーポレートサイト・ECサイト・LPなど幅広いジャンルの制作に携わり、レスポンシブ設計やUIアニメーションの実装にも対応。WordPressやShopifyを用いたテーマ開発も担当し、更新性・運用面を考慮した実装を行っている。\nまた、クライアントからの新規案件相談や保守・修正対応の第一窓口を担い、内容に応じてチームメンバーへの案件割り振りも行っている。",
  },
];
  ...
  return (
    <>
      <div className="relative z-10 mx-auto max-w-5xl px-6 py-16">
        ...
        <FadeInSection>
          <section>
            <h1 className="text-5xl font-extralight tracking-wide">About</h1>
            <div className="mt-8 space-y-4 leading-relaxed text-gray-600">
              <p>はじめまして、酒井成来と申します。</p>
              <p>
                大学卒業後、営業職を経てWeb制作会社に入社し、現在はコーダーとして約4年のキャリアを積んできました。
              </p>
              <p>
                入社当初はWebデザイナー兼コーダーとして働いていましたが、コーディングのやりがいを感じるようになり、コーディングメインのポジションへと転向しました。HTML/CSS/JavaScriptを用いたLP・コーポレートサイト・ECサイトの制作を中心に、WordPress・Shopifyのテーマ開発にも携わっています。
              </p>
              <p>
                「デザインカンプを忠実にコーディングする」だけにとどまらず、クライアントとの打ち合わせから参加し、要件整理や仕様設計にも積極的に関わってきました。背景にある課題を汲み取って設計に落とし込むことを、常に意識しています。
              </p>
              <p>
                現在は業務と並行して、React/Next.js/TypeScript/Supabaseを用いたアプリケーション開発を独学・個人開発を通じて学習中です。将来的にはフロントエンドを軸にしながらバックエンドの知識も身につけ、設計から実装まで一貫して関われるエンジニアへと成長していくことを目指しています。
              </p>
            </div>
          </section>
        </FadeInSection>
