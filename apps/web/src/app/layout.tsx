  ...
  return (
    <html lang="ja" className="bg-gray-50">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@300;400;500&family=Oswald:wght@200..400&display=swap" rel="stylesheet" />
      </head>
